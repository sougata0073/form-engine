...
public interface FormResponseService {
    ...
    FormResponseIndividualDto getIndividualFormResponse(UUID formId, Long formResponseId);

    FormResponseIndividualDto getIndividualFormResponseByPage(UUID formId, Long page);
